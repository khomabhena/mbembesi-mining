...
const JobDetailsEmployer = () => {
    const {setDetailsExpandedEmployer} = useStateContext()
    ...
    <div className=' overscroll-contain'>
        <div className='flex items-center gap-8'>
            <div onClick={() => setDetailsExpandedEmployer(prev => !prev)} className='text-2xl text-slate-600 cursor-pointer'><BsArrowReturnRight /></div>
