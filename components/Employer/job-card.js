...
const JobCardEmployer = () => {
    const {detailsExpanded, setDetailsExpandedEmployer} = useStateContext()

  return (
    <div onClick={() => setDetailsExpandedEmployer(prev => !prev)} className='bg-slate-50 rounded-md shadow-md px-8 py-4 mt-2 md:mt-0 cursor-pointer'>
