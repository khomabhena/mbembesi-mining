...
const CardManagement = ({data}) => {
  return (
    <div className='flex flex-col border rounded-lg items-center flex-1 cursor-pointer hover:scale-105 py-8 px-8'>
        <Image className=' h-28 w-28 object-top object-cover rounded-full' src={data?.imageLink} alt='' width={1000} height={1000} />
